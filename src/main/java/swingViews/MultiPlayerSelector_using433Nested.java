...
public class MultiPlayerSelector_using433Nested extends JFrame {
	private static final long serialVersionUID = 1L;	

	public MultiPlayerSelector_using433Nested() {
...
//        layeredPane.setPreferredSize(new Dimension(800, 1100));
        ...
        _433NestedGridBagPanel selectorsPanel = new _433NestedGridBagPanel();
		GridBagConstraints gbc_selectorsPanel = new GridBagConstraints();
		gbc_selectorsPanel.fill = GridBagConstraints.VERTICAL;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new MultiPlayerSelector_using433Nested());
    }
}
