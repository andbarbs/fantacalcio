...
public class SwingStarterLineUpChooser_Old extends JPanel implements LineUpChooserView {
	...
	public SwingStarterLineUpChooser_Old() throws IOException{
	...
	private void switchToScheme(String schemeKey) {
		...
		Stream.concat(
				...
				.forEach(selView -> Optional.ofNullable(selView.getParent())
						.ifPresent(parent -> parent.remove(selView)));
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> {
			...
			SwingStarterLineUpChooser_Old chooser;
			try {
				chooser = new SwingStarterLineUpChooser_Old();
