 ...
 * which are of interest to subclass SubstitutePlayerSelector.
 * 
 * The (incomplete) test case documents three supposedly equivalent APIs
 * that offer a varying degree of abstraction:
 ...
 * 
 * because of our wish to streamline StarterPlayerSelector, the silentlyDrop/Restore API
 * has been chosen as the preferred facility: the remaining two APIs stopped
 * being developed and thus lack tests for some scenarios
 */

@DisplayName("StarterPlayerSelector: protected local selection operators")
