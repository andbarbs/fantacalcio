 ...
 * {@link LineUp#extract()}
 */
class JpaLineUpRepository2Test {
	...
	void testSaveLineUpPersistsCorrectly() {
		...
		Goalkeeper gk2 = new Goalkeeper("Samir", "Handanović", Club.JUVENTUS);
		Goalkeeper gk3 = new Goalkeeper("Donnarumma", "Gianluigi", Club.JUVENTUS);
		Goalkeeper gk4 = new Goalkeeper("Walter", "Zenga", Club.JUVENTUS);

		Defender d1 = new Defender("Paolo", "Maldini", Club.JUVENTUS);
		Defender d2 = new Defender("Franco", "Baresi", Club.JUVENTUS);
		Defender d3 = new Defender("Alessandro", "Nesta", Club.JUVENTUS);
		Defender d4 = new Defender("Giorgio", "Chiellini", Club.JUVENTUS);
		Defender d5 = new Defender("Leonardo", "Bonucci", Club.JUVENTUS);
		Defender d6 = new Defender("Fabio", "Cannavaro", Club.JUVENTUS);
		Defender d7 = new Defender("Javier", "Zanetti", Club.JUVENTUS);

		Midfielder m1 = new Midfielder("Andrea", "Pirlo", Club.JUVENTUS);
		Midfielder m2 = new Midfielder("Daniele", "De Rossi", Club.JUVENTUS);
		Midfielder m3 = new Midfielder("Marco", "Verratti", Club.JUVENTUS);
		Midfielder m4 = new Midfielder("Claudio", "Marchisio", Club.JUVENTUS);
		Midfielder m5 = new Midfielder("Gennaro", "Gattuso", Club.JUVENTUS);
		Midfielder m6 = new Midfielder("Francesco", "Totti", Club.JUVENTUS);

		Forward f1 = new Forward("Roberto", "Baggio", Club.JUVENTUS);
		Forward f2 = new Forward("Alessandro", "Del Piero", Club.JUVENTUS);
		Forward f3 = new Forward("Lorenzo", "Insigne", Club.JUVENTUS);
		Forward f4 = new Forward("Filippo", "Inzaghi", Club.JUVENTUS);
		Forward f5 = new Forward("Luca", "Toni", Club.JUVENTUS);
		Forward f6 = new Forward("Christian", "Vieri", Club.JUVENTUS);
