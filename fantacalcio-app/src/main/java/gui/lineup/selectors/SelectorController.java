...
public interface SelectorController {
	...
	/**
	 * Allows the {@code SelectorWidget} collaborator to notify its
	 ...
	 * itself: see notes to {@link SelectorWidget}
	 *
	 * @param position the position of the option having been selected relative to
	 *                 the {@code SelectorWidget}'s current option list
	 */
	public void selectedOption(int position);
	
	/**
	 * Allows the {@code SelectorWidget}
	 ...
	 * see notes to {@link SelectorWidget}
	 */
