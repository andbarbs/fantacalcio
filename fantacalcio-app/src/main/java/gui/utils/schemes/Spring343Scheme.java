...
import domain.scheme.Scheme343;
...
public class Spring343Scheme extends SpringSchemePanel {
	...
	private void layDownSlots(Spring panelWidth, Spring panelHeight) {
		...
		getLayout().putConstraint(SpringLayout.NORTH, slot1, 
								goalieYoffset, 
								SpringLayout.NORTH, this);
		getLayout().putConstraint(SpringLayout.HORIZONTAL_CENTER, slot1, 
								Spring.constant(0),
	...
	public JPanel getMid1() {   return slot5;   }

	public JPanel getMid2() {   return slot6;   }

	public JPanel getMid3() {   return slot7;   }

	public JPanel getMid4() {   return slot8;   }
