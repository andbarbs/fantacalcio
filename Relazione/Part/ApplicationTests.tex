...
\subsubsection{Test UT1: Crea fantalega} \label{UT1}
...
\subsubsection{Test UT2: Genera calendario} \label{UT2}
...
\subsubsection{Test UT3: Assegna giocatori alle rose} \label{UT3}
...
\subsubsection{Test UT4: Calcola voti della giornata} \label{UT4}
...
\subsubsection{Test UT5: Unisciti alla lega} \label{UT5}
...
\subsubsection{Test UT6: Visualizza calendario} \label{UT6}
...
\subsubsection{Test UT7: Inserisci formazione} \label{UT7}
...
\subsubsection{Test UT8: Visualizza prossimo Match} \label{UT8}
...
\subsubsection{Test UT9: Visualizza classifica} \label{UT9}
...
\subsubsection{Test UT10: Scambia giocatori - Invia proposta} \label{UT10}
...
\subsubsection{Test UT11: Scambia giocatori - Accetta proposta} \label{UT11}
...
\subsubsection{Test UT12: Visualizza squadre} \label{UT12}
...
\subsubsection{Test UT13: Visualizza listone giocatori} \label{UT13}
...
\subsubsection{Test UT14: Assegna voti ai giocatori} \label{UT14}
...
Questo integration test verifica il corretto funzionamento del sistema di creazione di una nuova League,
...
Questo integration test verifica il corretto funzionamento del sistema di generazione del calendario della League,
...
Questo integration test verifica il corretto funzionamento del sistema di assegnazione dei Player ai FantaTeam che li hanno acquistati,
...
Questo integration test verifica il corretto funzionamento del sistema di calcolo dei voti della giornata una volta terminata,
implementando il template XXXXXXXX \todo{collegare al template}.
...
Questo integration test verifica il corretto funzionamento del sistema di ingresso in una League,
implementando il template XXXXXXXX \todo{collegare al template}.
...
Questo integration test verifica il corretto funzionamento del sistema di visualizzazione del calendario, cioè della lista dei Match,
implementando il template XXXXXXXX \todo{collegare al template}.
...
Questo integration test verifica il corretto funzionamento del sistema di salvataggio della LineUp,
...
Questo integration test verifica il corretto funzionamento del sistema di visualizzazione del prossimo Match,
implementando il template XXXXXXXX \todo{collegare al template}.
...
Questo integration test verifica il corretto funzionamento del sistema di visualizzazione della classifica,
implementando il template XXXXXXXX \todo{collegare al template}.
...
Questo integration test verifica il corretto funzionamento del sistema di invio di proposte di scambio di Player tra due FantaTeam,
...
Questo integration test verifica il corretto funzionamento del sistema di accettazione di una proposta di scambio di Player,
...
\subsubsection{Test IT6: Calcola risultati della giornata} \label{IT6}

Questo integration test verifica il corretto funzionamento del sistema di calcolo dei risultati della giornata corrente,
implementando il template \hyperref[UC-06]{UC-06}.
...
Questo integration test verifica il corretto funzionamento del sistema di visualizzazione di tutti i FantaTeam,
implementando il template XXXXXXXX \todo{collegare al template}.
...
Questo integration test verifica il corretto funzionamento del sistema di visualizzazione di tutti i giocatori,
implementando il template XXXXXXXX \todo{collegare al template}.
...
Questo integration test verifica il corretto funzionamento del sistema di assegnazione dei voti ai Player,
implementando il template XXXXXXXX \todo{collegare al template}.
