...
\subsubsection{Test UT XXX: Assegna giocatori alle rose} \label{UT5}
...
\subsubsection{Test UT XXX: Unisciti alla lega} \label{UT7}
...
\subsubsection{Test UT XXX: Visualizza classifica} \label{UT11}
...
\subsubsection{Test UT XXX: Scambia giocatori - Accetta proposta} \label{UT13}
...
\subsubsection{Test UT XXX: Visualizza squadre} \label{UT14}
...
\todo{Vanno aggiunti i test per il Login?}
...
\subsubsection{Test IT IT7: Unisciti alla lega} \label{IT7}
...
\subsubsection{Test IT IT16: Assegna voti ai giocatori} \label{IT16}
