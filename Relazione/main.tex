...
\usepackage{enumitem} % for lists with titled items
\usepackage{caption} % for gui composition figure 
\usepackage{nameref}

\usepackage[style=numeric,sorting=nty,backend=biber]{biblatex}
\addbibresource{Part/References.bib} % The name of your bib file
